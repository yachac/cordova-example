...
var page = new PluginPage(
    ...
    function(parent) {
        ...
        var buttonShortTop = tabris.create(
            "Button",
            {
        ...
        var buttonShortCenter = tabris.create(
            "Button",
            {
        ...
        var buttonShortBottom = tabris.create(
            "Button",
            {
        ...
        var buttonLongTop = tabris.create(
            "Button",
            {
        ...
        var buttonLongCenter = tabris.create(
            "Button",
            {
